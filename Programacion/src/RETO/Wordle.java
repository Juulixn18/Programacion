			...
			case 1:
				...
				for (int i = 0; i <= palabraSecreta.length(); i++) {
					...
					if (!haGanadoJugador(palabraJugador)) {
						...
						while (!comprobacionLongitudPalabra(palabraJugador) || !comprobacionLetraFinal(palabraJugador)
						...
						System.out.println(compruebaLetrasAcertadas(palabraJugador));// SE MOSTARA LAS LETRAS ACERTADAS
					}
					/**
